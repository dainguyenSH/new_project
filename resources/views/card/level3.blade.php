<!-- Option type level 2 -->
                <div class="typel-level-option-3" @if(Auth::merchant()->get()->package == 0) style="display:none" @endif>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text" name="vip3" id="point-1" data-v-min="0" data-v-max="100000" class="form-control currentcy" aria-label="VND" value="{{ $infoCard['value'][0]['value'][0]['point'] or '0' }}">
