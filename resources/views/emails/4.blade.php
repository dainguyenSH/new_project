<table>
	...
	<tr>
		<td style="padding: 25px 20px 0 20px;">
			<p>Chào {{ $data['name'] }},</p>
			<p>Chương trình thẻ thành viên dành cho {{ $data['trademark'] }} của bạn đã được kích hoạt thành công.</p>
		</td>
	</tr>
	<tr>
		<td style="padding: 0 20px;">
			<div style="text-align: right; border: 2px solid #f2728c; padding: 5px 20px 15px; background-color: #f9cedf; color: #f2728c;">
				<p style="text-align: initial;">Khách hàng của bạn có thể đăng ký trở thành thành viên qua ứng dụng “Abby” ngay từ bây giờ.</p>
