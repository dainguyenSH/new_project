...
<form enctype="multipart/form-data" id="upload_form" role="form" method="POST" action="">
    ...
    <h1 class="title-h1">Tạo mới Boo Merchant</h1>
    <div class="clearfix"></div>
        ...
        <button type="submit" class="btn pull-right btn-pink" id="addBooMerchant">Khởi tạo thẻ Boo Merchant</button>
        </div>

        <div class="col-lg-6">
            <div class="form-group">
                <label>Mô tả hạng thẻ</label>
                <textarea name="" rows="10" id="boo-card-option" class="form-control" placeholder="Mô tả hạng thẻ"></textarea>
            </div>
        </div>
