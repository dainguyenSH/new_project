...
@section('meta-title')
    <title>Update New Merchant - Super Administrator AbbyCard</title>
@stop
@section('css')
@stop
@section('title')
<div class="title-pages">
    <h2>Update New Merchant</h2>
</div>
@stop
@section('content')
    ...
    <div class="clearfix"></div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <input class="form-control checkhtmltag merchantName" type="text" id="" name="trademark" placeholder="Tên thương hiệu" value="{{ $data->name }}">
            </div>
        ...
        <button type="submit" class="btn pull-right btn-pink" data-id="{{ $data->id }}" id="updateNewMerchant">Update New Merchant</button>
        </div>
